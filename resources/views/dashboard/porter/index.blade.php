                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            @if ($porter->timeout_until && \Carbon\Carbon::parse($porter->timeout_until)->isFuture())
                                <button type="button" class="btn text-white d-flex align-items-center justify-content-center px-3 py-3"
                                        ...
                                        <div class="modal-content shadow-lg rounded-4 border-0">
                                            <div class="modal-body text-center p-4">
                                                ...
                                                <div class="d-flex justify-content-center gap-3">
                                                    ...
                                                    <form action="{{ route('dashboard.porters.update', $porter->id) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('PUT')
                                                        <input type="hidden" name="action" value="cancel_timeout">
                                                        <button type="submit" class="btn btn-warning px-4 rounded-pill">Cabut Timeout</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content shadow-lg rounded-4 border-0">
                                            <div class="modal-body text-center p-4">
                                                ...
                                                <p class="mb-4">
                                                    Apakah Anda yakin ingin memberikan timeout selama 2 hari kepada porter <br>
                                                ...
                                                <div class="d-flex justify-content-center gap-3">
                                                    ...
                                                    <form action="{{ route('dashboard.porters.update', $porter->id) }}" method="POST" class="d-inline">
                                                        ...
                                                        <button type="submit" class="btn btn-warning px-4 rounded-pill">Timeout</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="modal-content shadow-lg rounded-4 border-0">
                            <div class="modal-body text-center p-4">
                                ...
                                <div class="d-flex justify-content-center gap-3">
                                    <button type="button" class="btn btn-outline-secondary px-4 rounded-pill"
                                        data-bs-dismiss="modal">Batal</button>
                                    <form action="{{ route('dashboard.porters.destroy', $porter->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
