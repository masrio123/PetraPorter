                ...
                <form action="{{ route('dashboard.porters.update', $porter->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="porter_name" id="porter_name" class="form-control" required
                            value="{{ old('porter_name', $porter->porter_name) }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="porter_account_number" id="porter_account_number" class="form-control"
                            required value="{{ old('porter_account_number', $porter->porter_account_number) }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="porter_isOnline" id="porter_isOnline" class="form-select" required>
                            <option value="1"
                                {{ old('porter_isOnline', $porter->porter_isOnline) == 1 ? 'selected' : '' }}>Online
                            </option>
                            <option value="0"
                                {{ old('porter_isOnline', $porter->porter_isOnline) == 0 ? 'selected' : '' }}>Offline
                            </option>
                        </select>
                    </div>
